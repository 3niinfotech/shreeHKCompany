...
export const allProtectedRoutes = [
  ...
  { path: "/my-account", name: "My Account", element: <MyAccount />, alwaysAllow: true, hideFromNav: true },
  { path: "/settings", name: "Settings", element: <Setting />, alwaysAllow: true, hideFromNav: true },
  // { path: "/contact-support", element: <ContactSupport />, alwaysAllow: true, hideFromNav: true },
  { path: "/forbidden", name: "Access Denied", element: <Forbidden />, alwaysAllow: true, hideFromNav: true },
  { path: "/module/inventory/stonedetail.php", name: "Stone Detail", element: <StoneDetailAlias />, alwaysAllow: true, hideFromNav: true },
  { path: "/dai/module/inventory/stonedetail.php", name: "Stone Detail", element: <StoneDetailAlias />, alwaysAllow: true, hideFromNav: true },
  { path: "/inventory/stonedetail", name: "Stone Detail", element: <StoneDetailAlias />, alwaysAllow: true, hideFromNav: true },
];

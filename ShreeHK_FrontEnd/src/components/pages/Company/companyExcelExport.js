...
export const exportCompanyExcel = async (selectedRows) => {
    ...
    try {
        ...
        const fileName = `Company_${dd}${mm}${yyyy}`;
        XLSX.writeFile(wb, `${fileName}.xlsx`);

        toast.success(`Exported ${selectedRows.length} companies to Excel`);
        ...
        console.error("Company Excel Export Error:", err);
        toast.error("Failed to export Company Excel");
    }
};

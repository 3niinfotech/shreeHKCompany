const companyFields = [
  ...
  { type: "input", label: "Address", name: "address", required: true, span: 24 },
  { type: "input", label: "Country", name: "country", required: true, span: 12 },
  { type: "input", label: "Pincode", name: "pincode", required: true, span: 12 },
  { type: "input", label: "Email", name: "email", inputType: "email", required: true, span: 12 },
  { type: "input", label: "Contact No", name: "contact_number", required: true, span: 12 },
  { type: "input", label: "Fax", name: "fax", required: false, span: 12 },
  { type: "input", label: "Contact Person", name: "contact_person", required: true, span: 12 },

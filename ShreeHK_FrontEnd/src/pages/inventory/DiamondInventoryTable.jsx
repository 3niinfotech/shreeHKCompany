...
// /** Scroll body height from the flex table container (fills remaining viewport). */
...
//                 <span className="inventory-table-empty__title">No inventory records</span>
//                 <span className="inventory-table-empty__hint">
